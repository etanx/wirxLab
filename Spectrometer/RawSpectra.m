...
%   h-alpha, h-beta, and h-gamma are all within the view. 
%Changable HalphaPeak in px

%   Created by Michael Morken, 22 April 2015.

hAlphaPeak = 16; %Prospect by plotting the Raw Data
...
for i = 1:length(spectra_raw);
    ...
    lambda = (-1)*(offset*0.178)+ 656.6; %.178 is the nm per pixel on the 150 grating 656.6 is h-alphs
    wavelen(i) = lambda;
end
